...
knitr::include_graphics('./img_source/producex1/final.jpg')
```
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, out.width = '80%', fig.cap='디시인사이드 프로듀스x101 갤러리',fig.align='center'}
knitr::include_graphics('./img_source/producex2/dc_producexgallery.png')
```
...
```{r echo = FALSE, results = 'asis', fig.cap="크롤링을 마친 데이터의 구조"}

dc <-fread('C:/Users/JDW/Desktop/PROJECT/PRODUCEX/CRAWLING DATA/data/2019-06-1.csv')
...
knitr::include_graphics('./img_source/producex5/final.jpg')
```
